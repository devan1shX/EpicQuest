...
const deliverables = [
  {
    ...
    icon: Cpu,
    outputs: ["Working circuit & microcontroller code", "Iterative physical chassis designs", "Sensor calibration datasets"],
  },
  {
    tag: "PITCH",
    ...
    icon: Presentation,
    outputs: ["15-slide technical pitch deck", "Live recorded presentation defense", "Design storytelling narrative logs"],
  },
  {
    tag: "PORTFOLIO",
    ...
    icon: Folder,
    outputs: ["Exported STEP & STL CAD assemblies", "Detailed microelectronic schematics", "Chronological process journal blog"],
  },
  {
    tag: "RESEARCH NOTE",
    ...
    icon: FileText,
    outputs: ["LaTeX-formatted technical note", "Sensor readings & performance logs", "Future hardware optimization path"],
  },
];
      ...
      <section className="w-full bg-[#EAE2CE] py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-5 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-medium text-[#403011] tracking-tight leading-none mb-6">
            Build The Future Before College.
          </h2>
          
          <p className="text-base sm:text-lg text-[#4A4333] font-serif leading-relaxed max-w-xl mx-auto mb-10 italic">
            "Most students only read about hardware engineering in textbooks. EpicQuest students design, program, and build active, working robotics systems."
          </p>
