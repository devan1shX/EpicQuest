        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 relative">
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center">
              ...
              >
                The ultimate outcome is a verified professional experience, a strong reference letter, and the development of critical real-world skills that unequivocally demonstrate readiness for competitive university programs and future career success.
              </p>
