...
const steps: StepItem[] = [
  {
    ...
    desc: "Perform custom diagnostic profiling to align your interests and academic goals with selective corporate, research, or policy placements.",
    icon: Compass,
  },
  {
    num: "02",
    title: "Pre-Internship Coaching",
    desc: "Complete comprehensive prep, including resume building, interview simulations, workplace etiquette, and technical brief reviews.",
    icon: Search,
  },
  {
    num: "03",
    title: "Onboarding & Placement",
    desc: "Coordinate directly with your host supervisor to define core project deliverables, timeline milestones, and team structure.",
    icon: Settings,
  },
  {
    num: "04",
    title: "Immersive Placement",
    desc: "Spend 6–12 weeks on-site or in active digital workspace environments, delivering substantial contributions to live projects.",
    icon: ShieldCheck,
  },
  {
    num: "05",
    title: "Reference & Portfolio",
    desc: "Acquire a formal professional reference letter, verified certificate of completion, and synthesize findings into your portfolio.",
    icon: Award,
  },
];
...
const impactStats = [
  {
    icon: TrendingUp,
    value: "3×",
    label: "Admissions Boost",
    sub: "Offers from top-20 universities",
  },
  {
    icon: Clock,
    value: "6–12",
    label: "Weeks Duration",
    sub: "Bespoke timeline matching",
  },
  {
    icon: Globe,
    value: "4",
    label: "Diverse Tracks",
    sub: "Labs, Policy, Startups, Corporate",
  },
  {
    icon: CheckCircle,
    value: "100%",
    label: "Strength Aligned",
    sub: "Aligned to psychometric profile",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.88fr] gap-14 lg:gap-20 items-center">
            ...
            <div className="flex flex-col">
              ...
              >
                <p>
                  EpicQuest strategically places students in meaningful apprenticeships and internships with leading startups, innovative research labs, influential policy organizations, and established industry leaders. This unique opportunity allows students to build invaluable professional networks and accumulate real-world credentials even before they begin their university journey.
                </p>
                <p className="text-[#4A4333]/80 text-sm sm:text-[15px]">
                  This program is designed for ambitious students eager to gain hands-on professional experience that directly is aligned with the student's psychometric strengths and complements and enriches their academic achievements. It's an ideal pathway for those looking to apply classroom knowledge in dynamic, real-world settings.
                </p>
                <p className="text-[#4A4333]/70 text-[13px] sm:text-sm italic">
                  Students benefit from personalized placement matching, carefully aligned with their interests and psychometric profiles. They receive comprehensive pre-internship preparation coaching, ongoing mentorship throughout their placement, a professional reference letter from their host institution, and a meticulously documented experience for their academic and career portfolio.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden
                ...
                <Image
                  src="/images/program/apprenticeships_and_internships/Program_Apprenticeships_&_Internships.png"
                  alt="Apprenticeships &amp; Internships"
                  fill
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-serif font-semibold text-[#403011]">6 – 12 Weeks</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full bg-[#566544] py-5">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
            {[
              { icon: Clock, text: "6 – 12 Week Timeline" },
              { icon: ScrollText, text: "Verified Placement Experience" },
              { icon: Globe, text: "Labs · Policy · Startups · Corporate" },
              { icon: Award, text: "Ongoing Placement Mentors" },
            ].map(({ icon: Icon, text }) => (
      ...
      <section className="relative w-full bg-[#F6EBD4] py-20 sm:py-28 border-b border-[#4A4333]/10">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="text-center max-w-xl mx-auto">
            <span
              className="inline-flex items-center justify-center px-5 py-2 sm:px-6 sm:py-2.5 rounded-full bg-[#EAEDDE] text-[#403011] text-[11px] sm:text-[12px] font-serif uppercase tracking-widest w-fit mb-6 border border-[#403011]/15"
            >
            ...
            >
              Our <WavyUnderline>Placement Blueprint</WavyUnderline>
            </h2>
            <p className="text-sm sm:text-base text-[#4A4333]/80 font-serif leading-relaxed">
              Five structured milestones guiding you from initial alignment diagnostics
              to securing your professional references.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-16 lg:gap-24 items-center">
            ...
            <div className="flex flex-col gap-6">
              <span
                className="inline-flex items-center justify-center px-5 py-2 sm:px-6 sm:py-2.5 rounded-full bg-[#EAEDDE] text-[#403011] text-[11px] sm:text-[12px] font-serif uppercase tracking-widest w-fit border border-[#403011]/15"
              >
                Placement
              </span>
              <h2
              ...
              >
                Diverse <WavyUnderline>Placement Types</WavyUnderline>
              </h2>
              <blockquote className="border-l-2 border-[#DCA543] pl-6 font-serif italic
                                     text-base sm:text-lg text-[#4A4333] leading-relaxed">
                "Students who complete internships are 3x more likely to receive offers from top-20 universities."
              </blockquote>
              <p className="text-sm text-[#8A8373] font-serif">
                — EpicQuest Placement &amp; Corporate Board
              </p>
            </div>
              ...
              {[
                {
                  icon: Microscope,
                  title: "Research Labs",
                  desc: "Collaborate with university professors and industry researchers on cutting-edge projects.",
                },
                {
                  icon: Globe,
                  title: "Policy Organisations",
                  desc: "Intern with NGOs, think tanks, or government advisory bodies, influencing real-world policy.",
                },
                {
                  icon: Settings,
                  title: "Startups & Tech Firms",
                  desc: "Thrive in fast-paced, innovation-driven environments, gaining entrepreneurial experience.",
                },
                {
                  icon: Briefcase,
                  title: "Corporate & Industry",
                  desc: "Work within established companies in sectors like finance, healthcare, engineering, or media.",
                },
