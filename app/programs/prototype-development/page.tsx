...
const steps: StepItem[] = [
  {
    ...
    desc: "Collaborate with industry experts to define a viable, original problem statement and scope out your project's technical specifications.",
    icon: Compass,
  },
  {
    num: "02",
    title: "Design & Architecture",
    desc: "Create detailed blueprints, electrical schematics, software wireframes, or CAD models to map out the physical and digital structure.",
    icon: Search,
  },
  {
    num: "03",
    title: "Iterative Build",
    desc: "Engage in hands-on building, coding, or modeling using advanced tools and facilities under the direct guidance of expert mentors.",
    icon: Settings,
  },
  {
    num: "04",
    title: "Testing & Refinement",
    desc: "Execute rigorous testing cycles under real-world conditions to gather performance data and iteratively refine functionality and user experience.",
    icon: ShieldCheck,
  },
  {
    num: "05",
    title: "Portfolio Showcase",
    desc: "Finalise the working prototype, compose a comprehensive engineering project report, and film a high-impact video demonstration.",
    icon: Award,
  },
];
...
const impactStats = [
  {
    ...
    sub: "Across hardware, IoT & software",
  },
  {
    icon: Globe,
    value: "25+",
    label: "Patents Authored",
    sub: "Student co-inventors",
  },
  {
    icon: TrendingUp,
    value: "96%",
    label: "Lab Success Rate",
    sub: "From concept to working MVP",
  },
  {
    icon: CheckCircle,
    value: "94%",
    label: "Elite Acceptance Rate",
    sub: "Into top-25 STEM universities",
  },
];

export default function PrototypeDevelopmentPage() {
  return (
    <main className="flex flex-col w-full bg-[#F6EBD4] min-h-screen overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.88fr] gap-14 lg:gap-20 items-center">
            ...
            <div className="flex flex-col">
              ...
              >
                <p>
                  Our Prototype Development program is a hands-on journey for students passionate about bringing ideas to life. It’s designed for aspiring engineers, computer scientists, product designers, and entrepreneurs to create tangible, working prototypes that demonstrate innovation and problem-solving to elite university admissions committees.
                </p>
                <p className="text-[#4A4333]/80 text-sm sm:text-[15px]">
                  Students collaborate with expert mentors to scope projects, gain access to essential tools and resources, and navigate iterative build-test cycles. Each project culminates in a fully documented working prototype, accompanied by a comprehensive project report, ready for inclusion in their academic portfolio.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden
                ...
                <Image
                  src="/images/how_it_works/HowItWorks_PrototypeDevelopment.png"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-serif font-semibold text-[#403011]">3 – 5 Months</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full bg-[#566544] py-5">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
            {[
              { icon: Clock, text: "3 – 5 Month Timeline" },
              { icon: BookOpen, text: "Documented Working Prototype" },
              { icon: Settings, text: "Engineering · CS · Design · Biotech" },
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="text-center max-w-xl mx-auto animate-fade-up">
            ...
            <p className="text-sm sm:text-base text-[#4A4333]/80 font-serif leading-relaxed">
              ...
              to a fully functioning showcase prototype.
            </p>
          </div>
      ...
      {/* ════ KEY DISCIPLINES (WHY THIS MATTERS) ════ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-16 lg:gap-24 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <blockquote className="border-l-2 border-[#DCA543] pl-6 font-serif italic
                ...
                "Admissions committees for STEM and design are highly selective. A working, demonstrable prototype proves you aren't just memorising formulas — you are actively creating real-world solutions."
              </blockquote>
            ...
            {/* Right: Key Disciplines from User Screenshot */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              {[
                {
                  icon: Settings,
                  title: "Hardware Engineering",
                  desc: "Design and build physical components, circuits, and mechanical systems.",
                },
                {
                  icon: Code,
                  title: "Software & Apps",
                  desc: "Develop mobile, web, or desktop applications and intelligent software solutions.",
                },
                {
                  icon: PenTool,
                  title: "Industrial Design",
                  desc: "Focus on user experience, aesthetics, and product functionality for real-world impact.",
                },
                {
                  icon: Activity,
                  title: "Biotech & Science",
                  desc: "Create models, tools, or experiments in biological or scientific domains.",
                },
      ...
      <ProgramCTA
        title="Tangible Technical Excellence"
        description="A functional, beautifully engineered prototype transforms abstract potential into undeniable proof of your technical and creative mastery."
      />
    </main>
  );
}
