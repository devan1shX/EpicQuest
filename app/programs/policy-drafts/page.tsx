        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 relative">
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center">
              ...
              >
                The ultimate outcome is a submitted or published policy brief that serves as compelling evidence of your real-world civic engagement and your capacity to contribute to meaningful change, significantly strengthening your applications to Ivy League and other elite universities.
              </p>
