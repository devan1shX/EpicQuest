...
const steps: StepItem[] = [
  {
    ...
    desc: "Identify an active regional or global policy challenge that aligns with your interest profile, such as public health, AI ethics, or resource scarcity.",
    icon: Compass,
  },
  {
    num: "02",
    title: "Policy Research",
    desc: "Conduct quantitative and qualitative analysis, mapping existing legislation, stakeholders, public data, and relevant literature.",
    icon: Search,
  },
  {
    num: "03",
    title: "Framework & Analysis",
    desc: "Draft specific policy options, evaluate socioeconomic trade-offs, and design actionable, data-driven recommendations.",
    icon: Settings,
  },
  {
    num: "04",
    title: "Draft Synthesis",
    desc: "Meticulously compose your formal policy brief, adhering strictly to professional think-tank and government reporting protocols.",
    icon: ShieldCheck,
  },
  {
    num: "05",
    title: "Institutional Submission",
    desc: "Review your final proposal with policy advisors and submit the brief to active advocacy portals, think tanks, or NGOs.",
    icon: Award,
  },
];
...
const impactStats = [
  {
    icon: Users,
    value: "120+",
    label: "Policy Briefs Authored",
    sub: "By EpicQuest scholars globally",
  },
  {
    icon: Globe,
    value: "15+",
    label: "Partner Think Tanks",
    sub: "Respected NGOs & policy portals",
  },
  {
    icon: TrendingUp,
    value: "100%",
    label: "Custom-Designed",
    sub: "Bespoke civic & economic pathways",
  },
  {
    icon: CheckCircle,
    value: "94%",
    label: "Admissions Rate",
    sub: "Into top-25 elite universities",
  },
];

export default function PublishedPolicyDraftsPage() {
  return (
    <main className="flex flex-col w-full bg-[#F6EBD4] min-h-screen overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.88fr] gap-14 lg:gap-20 items-center">
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl sm:text-5xl md:text-[3.5rem] lg:text-[3.75rem]
                ...
                Published Policy
                <br />
                <span className="text-[#566544]">Briefs &amp; Drafts</span>
              </h1>
              ...
              >
                <p>
                  Our Published Policy Drafts program empowers students to author original, impactful policy briefs addressing critical real-world issues. These meticulously researched documents are prepared for submission to influential think tanks, respected NGOs, or governmental portals, providing an unparalleled platform to showcase civic leadership and sophisticated analytical thinking.
                </p>
                <p className="text-[#4A4333]/80 text-sm sm:text-[15px]">
                  This program is perfectly suited for intellectually curious students passionate about fields such as law, political science, economics, public health, international relations, or broader social impact. It offers a unique opportunity to translate academic interests into tangible influence and advocacy.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden
                ...
                <Image
                  src="/images/program/policyDraft/Program_PolicyDrafts.png"
                  alt="Published Policy Drafts"
                  fill
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-serif font-semibold text-[#403011]">3 – 4 Months</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full bg-[#566544] py-5">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
            {[
              { icon: Clock, text: "3 – 4 Month Timeline" },
              { icon: BookOpen, text: "Submitted or Published Brief" },
              { icon: Globe, text: "Law · Policy · Economics · Advocacy" },
      ...
      <section className="relative w-full bg-[#F6EBD4] py-20 sm:py-28 border-b border-[#4A4333]/10">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="text-center max-w-xl mx-auto">
            ...
            >
              Our <WavyUnderline>Policy Blueprint</WavyUnderline>
            </h2>
            <p className="text-sm sm:text-base text-[#4A4333]/80 font-serif leading-relaxed">
              Five structured milestones guiding you from domain selection
              to a formally submitted or published policy draft.
            </p>
          </div>
      ...
      {/* ════ KEY POLICY AREAS (WHY THIS MATTERS) ════ */}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-16 lg:gap-24 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                Key <WavyUnderline>Policy Areas</WavyUnderline>
              </h2>
              <blockquote className="border-l-2 border-[#DCA543] pl-6 font-serif italic
                                     text-base sm:text-lg text-[#4A4333] leading-relaxed">
                "Elite admissions committees look for civic courage and analytical capacity. A published policy draft is an exceptional, tangible demonstration of your academic voice."
              </blockquote>
              <p className="text-sm text-[#8A8373] font-serif">
                — EpicQuest Public Policy Board
              </p>
            </div>

            {/* Right: Key Policy Areas */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              {[
                {
                  icon: Globe,
                  title: "Climate & Environment",
                  desc: "Analyze conservation models, green energy transitions, or regional carbon pricing frameworks.",
                },
                {
                  icon: Activity,
                  title: "Public Health",
                  desc: "Advise on healthcare accessibility, epidemic preparedness, or medical resource logistics.",
                },
                {
                  icon: TrendingUp,
                  title: "Economic Policy",
                  desc: "Examine regional trade, municipal taxation, fiscal stimuli, or labor supply dynamics.",
                },
                {
                  icon: ScrollText,
                  title: "Education Reform",
                  desc: "Address curricula disparities, digital learning infrastructures, or school resource allocations.",
                },
                {
                  icon: Settings,
                  title: "Technology & Governance",
                  desc: "Formulate frameworks for AI ethics, algorithmic bias, data privacy, or cybersecurity standards.",
                },
      ...
      <ProgramCTA
        title="Empirical Leadership & Advocacy"
        description="Authored policy drafts showcase your ability to synthesize complex societal challenges into actionable frameworks — highlighting true leadership potential."
      />
    </main>
  );
}
